...
<body>
    <div class="container-fluid" style="background-color:#17011F">

        <div class="row">
            <div class="col" style="padding-left:60px;padding-top:30px">
                <img src="public/images/new_logo.png" width="200px">
            </div>

            <div class="col" style="padding-right:60px;padding-top:30px">
                <div class="float-end">
                    <button class="btn btn-primary border-0" style="background-image: linear-gradient(to right, #ff6a00, #ee0979);color: #fff;width:150px" onclick="window.location.href = '/login';">Login</button>
                    <button class="btn btn-primary border-0" style="background-color:#4d1460;width:150px" onclick="window.location.href = '/login';">Register</button>
                </div>
            </div>
        </div>

        <div class="row">
            <div class="col-md-12 justify-content-center" style="background-image: url('public/images/home_illustration.svg');background-size: cover;background-position: right;height: 768px;background-size: 50%;background-repeat: no-repeat;">
                <div class="" style="padding-top: 93px;">
                    <img src="public/images/star-img-white.png">
                    <img src="public/images/left-banner-2.png" class="img-fluid">
                    <!-- <h1 style="color:#fff;font-size: 70px;">Welcome to</h1>
                    <img src="images/new_logo.png" style="width:500px">
                    <h1 style="color:#fff;font-size: 70px;">First Deposit offer</h1>
                    <h1 style="color:#fff;font-size: 70px;">Cash Bonus MYR100</h1>
                    <h1 style="color:#fff;font-size: 70px;">Plus 10 Free Spins</h1> -->
                    <img src="public/images/star-img-white.png" style="position: absolute;left: 700px;">
                </div>
        ...
        <div class="row video-section" style="padding-top:5%;">
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-center">
                    <button type="button" class="btn btn-outline-light rounded-pill mx-2" style="width:150px">Live Casino</button>
                    <button type="button" class="btn btn-outline-light rounded-pill mx-2" style="width:150px">Slots</button>
                    <button type="button" class="btn btn-outline-light rounded-pill mx-2" style="width:150px">Sports</button>
                    <button type="button" class="btn btn-outline-light rounded-pill mx-2" style="width:150px">4D</button>
                    <button type="button" class="btn btn-outline-light rounded-pill mx-2" style="width:150px">Fishing</button>
                </div>
            </div>
        ...
        <div class="row video-section" style="padding-top:5%;">
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-center">
                    <img src="public/images/games/lc-ab-icon.png" class="flex-fill mx-1 img-fade-all" style="max-width: 13%;height:240px;cursor:pointer">
                    <img src="public/images/games/lc-ag-icon.png" class="flex-fill mx-1 img-fade-all" style="max-width: 13%;height:240px;cursor:pointer">
                    <img src="public/images/games/lc-pp-icon.png" class="flex-fill mx-1 img-fade-all" style="max-width: 13%;height:240px;cursor:pointer">
                    <img src="public/images/games/lc-pt-icon.png" class="flex-fill mx-1 img-fade-all" style="max-width: 13%;height:240px;cursor:pointer">
                    <img src="public/images/games/lc-sexy-icon.png" class="flex-fill mx-1 img-fade-all" style="max-width: 13%;height:240px;cursor:pointer">
                    <img src="public/images/games/lc-evo-icon.png" class="flex-fill mx-1 img-fade-all" style="max-width: 13%;height:240px;cursor:pointer">
                    <img src="public/images/games/lc-micro-icon.png" class="flex-fill mx-1 img-fade-all" style="max-width: 13%;height:240px;cursor:pointer">
                </div>
            </div>
        ...
        <div class="row video-section" style="padding-top:5%;">
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-center">
                    <img src="public/images/steps.png" class="img-fluid">
                </div>
            </div>
        ...
        <div class="row video-section" style="padding-top:5%;">
            ...
            <div class="col-md-6 my-div d-flex justify-content-center">
                <!-- <img src="images/star-img-red.png" width="50px"> -->
                <img src="public/images/left-image.png">
            </div>
        ...
        <div class="row video-section" style="padding-top:5%;">
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-center">
                    <img src="public/images/steps-2.png" class="img-fluid">
                </div>
            </div>
        ...
        <!-- footer -->
        <div class="row">
            <img src="public/images/big-image.png" class="img-fluid">
        </div>
