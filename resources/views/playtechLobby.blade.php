...
<body onload="login()">
    ...
    <div>
        <input type="text" id="username" name="username" value="{{ request()->username }}" style="display:none"><br><br>
        <input type="text" id="password" name="password" value="{{ request()->password }}" style="display:none"><br><br>
        <input type="text" id="lang" name="lang" value="en" style="display:none"><br><br>
        <input type="text" id="client" name="client" value="{{ request()->client }}" style="display:none"><br><br>
        <input type="text" id="mode" name="mode" value="{{ request()->mode }}" style="display:none"><br><br>
        <input type="text" id="game" name="game" value="{{ request()->game_code }}" style="display:none"><br><br>
