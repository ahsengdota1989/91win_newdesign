...
<body>
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <!-- left sidebar -->
            @include('layouts.sidebar.left-sidebar-promotions')
            ...
            <div class="col py-3 content-purple-bg">
                ...
                <div class="row video-section" style="padding-top:5%;">
                    ...
                    <div class="col-md-4">
                        ...
                        <img src="https://i.ibb.co/N1Wf5GJ/91win-168-2.png" class="img-fluid">
                        <h1 style="color:#fff">168% Welcome Bonus</h1>
                        <button class="btn btn-primary border-0" style="background-image: linear-gradient(to right, #ff6a00, #ee0979);color: #fff;width:150px">View More</button>
                        <button class="btn btn-primary border-0" style="background-color:#4d1460;width:150px">Apply Now</button>
