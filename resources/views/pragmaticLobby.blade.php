<div class="row d-flex justify-content-left">
 ...
 <div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia"
 ...
 <div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs5joker.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs5joker", "Pragmatic")' />
    </div>
</div>

 <div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20bonzgold.png"
 ...
 <div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20fruitsw.png"
 ...
 <div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs10cowgold.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20rhino.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs20rhino", "Pragmatic")' />
    </div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs15diamond.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vswaysrhino.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vswaysrhino", "Pragmatic")' />
    <div class="slot-info-wrap">Great Rhino Megaways</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs1dragon8.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs1dragon8", "Pragmatic")' />
    <div class="slot-info-wrap">888 Dragons</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20sbxmas.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vswaysdogs.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs7776aztec.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs7776aztec", "Pragmatic")' />
    <div class="slot-info-wrap">Aztec Bonanza</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs7fire88.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs7fire88", "Pragmatic")' />
    <div class="slot-info-wrap">Fire 88</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs243lions.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25chilli.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs25chilli", "Pragmatic")' />
    <div class="slot-info-wrap">Chilli Heat</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25mustang.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs5ultra.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs75empress.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20godiva.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs20godiva", "Pragmatic")' />
    <div class="slot-info-wrap">Lady Godiva</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25goldpig.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs25goldpig", "Pragmatic")' />
    <div class="slot-info-wrap">Golden Pig</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs10fruity2.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs10fruity2", "Pragmatic")' />
    <div class="slot-info-wrap">Extra Juicy</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25pyramid.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs75bronco.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs1ball.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs5hotburn.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs5hotburn", "Pragmatic")' />
    <div class="slot-info-wrap">Hot to Burn</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs40pirate.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs40pirate", "Pragmatic")' />
    <div class="slot-info-wrap">Pirate Gold</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25mmouse.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs25mmouse", "Pragmatic")' />
    <div class="slot-info-wrap">Money Mouse</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs5super7.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs5spjoker.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25newyear.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs1money.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs1money", "Pragmatic")' />
    <div class="slot-info-wrap">Money Money Money</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs40pirgold.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs40pirgold", "Pragmatic")' />
    <div class="slot-info-wrap">Pirate Gold Deluxe</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25journey.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs1600drago.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20kraken.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs18mashang.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs18mashang", "Pragmatic")' />
    <div class="slot-info-wrap">Treasure Horse</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs1tigers.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20bl.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25asgard.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20hercpeg.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs20hercpeg", "Pragmatic")' />
    <div class="slot-info-wrap">Hercules and Pegasus</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20wildpix.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs20wildpix", "Pragmatic")' />
    <div class="slot-info-wrap">Wild Pixies</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vswayshive.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25samurai.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25safari.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs25safari", "Pragmatic")' />
    <div class="slot-info-wrap">Hot Safari</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs5ultrab.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs5ultrab", "Pragmatic")' />
    <div class="slot-info-wrap">Ultra Burn</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs50pixie.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs50pixie", "Pragmatic")' />
    <div class="slot-info-wrap">Pixie Wings</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25peking.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs25peking", "Pragmatic")' />
    <div class="slot-info-wrap">Peking Luck</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20chicken.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs9chen.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs9chen", "Pragmatic")' />
    <div class="slot-info-wrap">Master Chen's Fortune</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs5trjokers.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs5trjokers", "Pragmatic")' />
    <div class="slot-info-wrap">Triple Jokers</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20eking.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs20eking", "Pragmatic")' />
    <div class="slot-info-wrap">Emerald King</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20honey.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs20honey", "Pragmatic")' />
    <div class="slot-info-wrap">Honey Honey Honey</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25walker.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs25walker", "Pragmatic")' />
    <div class="slot-info-wrap">Wild Walker</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25davinci.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs25davinci", "Pragmatic")' />
    <div class="slot-info-wrap">Da Vinci's Treasure</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/cs3w.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs1fufufu.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs3train.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs3train", "Pragmatic")' />
    <div class="slot-info-wrap">Gold Train</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs9hotroll.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs7monkeys.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs7monkeys", "Pragmatic")' />
    <div class="slot-info-wrap">7 Monkeys</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25sea.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20santa.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs10madame.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25vegas.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs40beowulf.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs40beowulf", "Pragmatic")' />
    <div class="slot-info-wrap">Beowulf</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs50aladdin.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs50aladdin", "Pragmatic")' />
    <div class="slot-info-wrap">3 Genie Wishes</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs7pigs.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20gorilla.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs50amt.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs50amt", "Pragmatic")' />
    <div class="slot-info-wrap">Aladdin's Treasure</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs10egypt.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs10egypt", "Pragmatic")' />
    <div class="slot-info-wrap">Ancient Egypt</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20egypt.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs20egypt", "Pragmatic")' />
    <div class="slot-info-wrap">Tales of Egypt</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs13g.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25dwarves.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20cm.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs20cm", "Pragmatic")' />
    <div class="slot-info-wrap">Sugar Rush</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20rome.png"
...
<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20cmv.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs20cmv", "Pragmatic")' />
    <div class="slot-info-wrap">Sugar Rush Valentine's Day</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs15ktv.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs15ktv", "Pragmatic")' />
    <div class="slot-info-wrap">KTV</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20cw.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs20cw", "Pragmatic")' />
    <div class="slot-info-wrap">Sugar Rush Winter</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs15b.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs15b", "Pragmatic")' />
    <div class="slot-info-wrap">Crazy 7s</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20hockey.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs20hockey", "Pragmatic")' />
    <div class="slot-info-wrap">Hockey League</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20gg.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs20gg", "Pragmatic")' />
    <div class="slot-info-wrap">Spooky Fortune</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25h.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs25h", "Pragmatic")' />
    <div class="slot-info-wrap">Fruity Blast</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs9hockey.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs9hockey", "Pragmatic")' />
    <div class="slot-info-wrap">Hockey League Wild Match</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs25champ.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs25champ", "Pragmatic")' />
    <div class="slot-info-wrap">The Champions</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs20cms.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs20cms", "Pragmatic")' />
    <div class="slot-info-wrap">Sugar Rush Summer Time</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs9catz.png"
    onclick='window.open("{{url('launchPragmaticSlots')}}/vs9catz", "Pragmatic")' />
    <div class="slot-info-wrap">The Catfather</div>
</div>

<div class="col-2" style="padding:5px">
    <div class="image-container"><img class="img-fluid" alt="slots-in-malaysia" src="https://api.prerelease-env.biz/game_pic/rec/160/vs30catz.png"
