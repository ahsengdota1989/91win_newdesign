...
<body>
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <!-- left sidebar -->
            @include('layouts.sidebar.left-sidebar-profile')
            ...
            <div class="col py-3 content-purple-bg">
                ...
                <div class="row video-section" style="padding-top:5%;">
                    ...
                    <div class="col-md-4">
                        <h1 style="color:#fff;font-size:17px">Personal Details</h1>

                        <div class="group">
                            <label for="inputName" class="form-label" style="color:white">Full Name</label>
                            <input type="text" class="form-control" style="background-color: transparent;color:white" value="GLEN NINGKAN" readonly>
                        </div>
                        <div class="group">
                            <label for="inputName" class="form-label" style="color:white">Username</label>
                            <input type="text" class="form-control" style="background-color: transparent;color:white" value="GLEN NINGKAN" readonly>
                        </div>
                    </div>

                    <div class="col-md-4">
                        <h1 style="color:#fff;font-size:17px">Update Phone Number</h1>
                        ...
                        <div class="group">
                            <button class="btn btn-primary w-100" style="background-image: linear-gradient(to right, #C147E9, #E94747);color: #fff;">Save</button>
                        </div>
                    </div>
                ...
                <div class="row video-section" style="padding-top:5%;">
                    ...
                    <div class="col-md-4">
                        <h1 style="color:#fff;font-size:17px">Update Email Address</h1>
                    ...
                    <div class="col-md-4">
                        <h1 style="color:#fff;font-size:17px">Update Password</h1>
