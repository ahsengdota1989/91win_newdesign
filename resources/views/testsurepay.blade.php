...
<form id="surepay-form" method="post" action="https://pgw3.surepay88.com/fundtransfer">
    ...
    <input type="hidden" name="contractname" value="SPRMRR2006">
    ...
    <input type="hidden" name="failed_return_url" value="https://91win88.com/depositpage">
    <input type="hidden" name="return_url" value="https://91win88.com/depositpage">
